...
$CONTENT_SERVER = "http://localhost:#{$SERVER_PORT}/eol_php_code/applications/content_server/"
...
$WEB_SERVICE_BASE_URL = "http://localhost:#{$SERVER_PORT}/eol_php_code/applications/content_server/service.php?" # web service is used for importing content partners' data
